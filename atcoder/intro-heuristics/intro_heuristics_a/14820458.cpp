// URL: https://atcoder.jp/contests/intro-heuristics/submissions/14820458
// Date: Sun, 28 Jun 2020 22:47:58 +0900
...
i64 eval(vector<i64> &ans, i64 t = -1)
{
  i64 score = (t == -1 ? 0 : ts[t]);
  i64 last[26] = {};
  t = max(t, 0LL);
  for (i64 i = 0; i < t; i++)
    last[ans[i]] = i + 1;
...
void solve()
{
  ...
  i64 currentTime;
  vector<i64> now = ans;
  i64 bestScore = -1e18, nowScore = eval(now), loop = 0;
